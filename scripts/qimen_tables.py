"""奇门遁甲 静态表 — 九宫/八门/九星/八神/三奇六仪/节气三元局数/旬首。

从 qimen_cast.py 拆出: 该文件在补齐输入契约后到了 802 行, 越过仓库自设的 800 行
上限 (tests/test_harness_gates.py 强制)。拆的是纯数据, 函数留在原处, 无行为改动
—— 与 bazi/ziwei 先前的拆法一致。
"""
