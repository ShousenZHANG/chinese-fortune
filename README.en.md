...
- **Calendrically rigorous** — true solar time, solar-term month boundaries, the 立春 year boundary, late-子时, and leap months are all correct, and cross-checked against the **independent `sxtwl` engine**: the day pillar is compared on every one of the 58,440 days from 1920 to 2080 with zero divergence; year/month pillars are compared on a 447-point grid (skipping solar-term days, where the granularity differs).
